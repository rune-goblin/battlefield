# C2 remediation — follow-up tasks

W1–W11 of `docs/plans/c2-remediation.md` are done and merged to `master` (2026-09-26). This file
holds the follow-ups the waves found. A task leaves the list when it is done; a question leaves
