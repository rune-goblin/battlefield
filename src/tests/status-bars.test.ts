...
describe('Health and Morale presentation', () => {
  it.each([
    [0, 0, 4, 3, 'Health 4/4', 'Morale 3/3'],
    [2, 2, 2, 1, 'Health 2/4', 'Morale 1/3'],
    [3, 3, 1, 0, 'Health 1/4', 'Morale 0/3 — routed'],
    [4, 1, 0, 2, 'Health 0/4 — destroyed', 'Morale 2/3'],
  ] as const)('maps stored losses %i/%i to remaining Health %i and Morale %i',
    (wounds, disorder, health, morale, healthLabel, moraleLabel) => {
      const bars = statusBars(wounds, disorder);
