...
<style>
  ...
  .head { display: flex; align-items: center; justify-content: space-between; gap: .5rem; font-size: .85rem; }
  .name em { font-style: normal; font-size: .7rem; color: var(--muted); }
  .head input[type=color] { width: 3rem; height: 1.4rem; padding: 0; border: 1px solid var(--rule); border-radius: 4px; background: none; }
  .slider { display: flex; justify-content: space-between; width: 100%; font-size: .8rem; color: var(--muted); margin-top: .35rem; }
