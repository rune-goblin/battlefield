<script lang="ts">
  ...
  const tokens: TokenModel[] = [
    { kind: 'unit', id: 'caster', side: 'attacker', name: 'Apprentice Magician Clique', role: 'infantry', level: 5, cell: CASTER, wounds: 0, disorder: 0, quality: 3, engine: null, prop: null, ring: null },
    { kind: 'unit', id: 'target', side: 'defender', name: 'Kobold Warriors', role: 'infantry', level: 3, cell: TARGET, wounds: 1, disorder: 0, quality: 3, engine: null, prop: null, ring: null },
  ];
