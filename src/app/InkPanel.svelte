...
<style>
  ...
  .tabs button { flex: 1; padding: .35rem .5rem; font-size: var(--type-body); }
  ...
  nav button { padding: .25rem .5rem; font-size: var(--type-small); }
  ...
  .select { display: flex; justify-content: space-between; align-items: center; gap: .5rem; width: 100%; font-size: var(--type-body); margin: .5rem 0; }
  .select select { flex: 1; max-width: 60%; font-size: var(--type-body); }
  ...
  .no-art { background: var(--band); color: var(--muted); font-size: var(--type-small); border-radius: 7px; padding: .8rem; }
  .levels { display: flex; gap: .35rem; margin: .7rem 0 0; }
  .levels button { flex: 1; padding: .25rem .4rem; font-size: var(--type-small); font-variant-numeric: tabular-nums; }
  ...
  footer button { font-size: var(--type-small); }
