...
<style>
  ...
  .notification { display: flex; gap: .6rem; align-items: flex-start; padding: .65rem .8rem; border: 1px solid var(--rule); border-radius: 8px; background: var(--card); color: var(--ink); font-size: .85rem; box-shadow: 0 2px 8px rgba(0, 0, 0, .25); }
  ...
  .copy { display: flex; flex: 1; min-width: 0; flex-direction: column; gap: .3rem; line-height: 1.4; overflow-wrap: anywhere; }
  .symbol { flex-shrink: 0; width: 1.7rem; height: 1.3rem; object-fit: contain; text-align: center; font-weight: bold; }
  button { pointer-events: auto; flex-shrink: 0; padding: 0 .3rem; color: var(--muted); background: transparent; border: 0; font: inherit; font-size: 1.1rem; cursor: pointer; }
</style>
