...
<style>
  ...
  .notification { display: flex; gap: .6rem; align-items: flex-start; padding: .65rem .8rem; border: 1px solid var(--rule); border-radius: 8px; background: var(--card); color: var(--ink); font-size: var(--type-body); box-shadow: 0 2px 8px rgba(0, 0, 0, .25); }
