...
function doGate(state: BattleState, u: Unit, action: GateAction): number {
...
function attackWall(state: BattleState, rng: Rng, u: Unit, key: string, modifier: number, label: string) {
