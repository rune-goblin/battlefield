...
export const ENGINES: SiegeEngineCard[] = [
  { name: "Teekdoon", level: 1, kind: 'artillery', launch: 4, reach: 'medium', defence: 11, sourceSpeed: null, speed: null, loadCost: 1, loadSteps: 1 }, // Howl of the Wild
  ...
  { name: "Nullifier Sling", level: 11, kind: 'artillery', launch: 17, reach: 'extreme', defence: 25, sourceSpeed: 15, speed: 10, loadCost: 1, loadSteps: 1 }, // Battlecry!
  { name: "Seedpod Shooter", level: 11, kind: 'artillery', launch: 17, reach: 'extreme', defence: 26, sourceSpeed: 0, speed: 0, loadCost: 1, loadSteps: 1 }, // Howl of the Wild
  ...
  { name: "Glacial Zephyr", level: 15, kind: 'artillery', launch: 23, reach: 'medium', defence: 34, sourceSpeed: 20, speed: 20, loadCost: 2, loadSteps: 1 }, // Battlecry!
  ...
  { name: "Fists of Divinity", level: 20, kind: 'artillery', launch: 29, reach: 'medium', defence: 40, sourceSpeed: 5, speed: 10, loadCost: 1, loadSteps: 1 }, // Battlecry!
];
