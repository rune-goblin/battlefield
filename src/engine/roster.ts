...
export const ROSTER: UnitCard[] = [
  ...
  { name: 'Slingers', level: 3, role: 'infantry', salvo: 'short', tactics: [] },
  { name: 'Longbowmen', level: 4, role: 'infantry', salvo: 'medium', pace: false, tactics: ['covering-fire'] },
  { name: 'Light Horse', level: 5, role: 'cavalry', salvo: 'short', tactics: [] },
  ...
  { name: 'Wyvern Riders', level: 12, role: 'cavalry', fear: true, salvo: 'medium', tactics: ['ambush'] },
